...
void addStudent(Student s)
{
    ...
    ofstream out("D:/student_managment/Student.txt", ios::app);
    if (!out)
    {
...
void search(Student s)
{
    ...
    ifstream in("D:/student_managment/Student.txt");
    if (!in)
    {
...
void update()
{
    ...
    ofstream out("D:/student_managment/Student Temp.txt");
    if (!out)
    {
        cout << "Error:";
        out.close();
    ...
    out.close();
    in.close();
    remove("D:/student_managment/Student.txt");
    rename("D:/student_managment/Student Temp.txt", "D:/Student.txt");
}
